...
class Apiservice():
    ...
    def __init__(self):
      ...
      self.conn = psycopg2.connect(user="startup",password="dTuNVFo0x6UHvQytE4nG",host="startup-db.cffqqxxt5nqv.us-east-1.rds.amazonaws.com",port=5432,dbname="startup")
